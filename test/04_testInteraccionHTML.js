...
describe("Generación de datos estáticos", () => {
    ...
    it("Función mostrarGastosAgrupadosWeb - Agrupación por día", () => {
        ...
        cy.get("#agrupacion-dia > div.agrupacion > div.agrupacion-dato > div.agrupacion-dato-clave").should((divs) => {
            expect(divs, "Deben mostrarse 5 etiquetas 'agrupacion-dato-clave'").to.have.length(5);
        });
        cy.get("#agrupacion-dia > div.agrupacion > div.agrupacion-dato > div.agrupacion-dato-valor").should((divs) => {
    ...
    it("Función mostrarGastosAgrupadosWeb - Agrupación por mes", () => {
        ...
        cy.get("#agrupacion-mes > div.agrupacion > div.agrupacion-dato > div.agrupacion-dato-clave").should((divs) => {
            expect(divs, "Deben mostrarse 3 etiquetas 'agrupacion-dato-clave'").to.have.length(3);
        });
        cy.get("#agrupacion-mes > div.agrupacion > div.agrupacion-dato > div.agrupacion-dato-valor").should((divs) => {
    ...
    it("Función mostrarGastosAgrupadosWeb - Agrupación por año", () => {
        ...
        cy.get("#agrupacion-anyo > div.agrupacion > div.agrupacion-dato > div.agrupacion-dato-clave").should((divs) => {
            expect(divs, "Deben mostrarse 2 etiquetas 'agrupacion-dato-clave'").to.have.length(2);
        });
        cy.get("#agrupacion-anyo> div.agrupacion > div.agrupacion-dato > div.agrupacion-dato-valor").should((divs) => {
