...
function repintar(){
    ...
    mostrarGastosAgrupadosWeb("agrupacion-dia",gastoAgrup1,"día")

    let gastoAgrup2 = gesPre.agruparGastos("mes")
    mostrarGastosAgrupadosWeb("agrupacion-mes",gastoAgrup2,"mes")

    let gastoAgrup3 = gesPre.agruparGastos("anyo")

    mostrarGastosAgrupadosWeb("agrupacion-anyo",gastoAgrup3,"año")
}
...
function EditarHandleFormulario(){
    this.handleEvent = function(event){
        ...
        editApiEvent.formulario = formulario;
        editApiEvent.gasto = this.gasto;
        formulario.querySelector("button[class='gasto-enviar-api']").addEventListener('click', editApiEvent);
