...
// Crear gasto
let gasto1 = new GesPresu.CrearGasto("Compra carne", 23.44, "2021-10-06", "casa", "comida");
let gasto2 = new GesPresu.CrearGasto("Compra fruta y verdura", 14.25, "2021-09-06", "supermercado", "comida");
let gasto3 = new GesPresu.CrearGasto("Bonobús", 18.60,"2020-05-26","transporte");
let gasto4 = new GesPresu.CrearGasto("Gasolina", 60.42, "2021-10-08", "transporte", "gasolina");
let gasto5 = new GesPresu.CrearGasto("Seguro hogar", 206.45,"2021-09-26","casa","seguros");
let gasto6 = new GesPresu.CrearGasto("Seguro coche", 195.78, "2021-10-06", "transporte", "seguros");
//Añadir Gasto
...
GesPresuWeb.mostrarGastoWeb("listado-gastos-filtrado-1",GesPresu.filtrarGastos({fechaDesde:"2021-09-01",fechaHasta:"2021-09-30"}))
//listado de gasto > 50€
